...
import static com.example.administrator.customseekbar.CustomSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.example.administrator.customseekbar.CustomSeekBar.TextPosition.BOTTOM_SIDES;
import static com.example.administrator.customseekbar.CustomSeekBar.TextPosition.SIDES;
...
public class CustomSeekBar  extends View{
    ...
    private SeekBarConfigBuilder mConfigBuilder; // config attributes
    ...
    public CustomSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMin = a.getFloat(R.styleable.CustomSeekBar_bsb_min, 0.0f);
        mMax = a.getFloat(R.styleable.CustomSeekBar_bsb_max, 100.0f);
        mProgress = a.getFloat(R.styleable.CustomSeekBar_bsb_progress, mMin);
        isFloatType = a.getBoolean(R.styleable.CustomSeekBar_bsb_is_float_type, false);
        mTrackSize = a.getDimensionPixelSize(R.styleable.CustomSeekBar_bsb_track_size, dp2px(2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.CustomSeekBar_bsb_second_track_size,
                mTrackSize + dp2px(2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.CustomSeekBar_bsb_thumb_radius,
                mSecondTrackSize + dp2px(2));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.CustomSeekBar_bsb_thumb_radius_on_dragging,
                mSecondTrackSize * 2);
        mSectionCount = a.getInteger(R.styleable.CustomSeekBar_bsb_section_count, 10);
        mTrackColor = a.getColor(R.styleable.CustomSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.colorPrimary));
        mSecondTrackColor = a.getColor(R.styleable.CustomSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.colorAccent));
        mThumbColor = a.getColor(R.styleable.CustomSeekBar_bsb_thumb_color, mSecondTrackColor);
        isShowSectionText = a.getBoolean(R.styleable.CustomSeekBar_bsb_show_section_text, false);
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.CustomSeekBar_bsb_section_text_size, sp2px(14));
        mSectionTextColor = a.getColor(R.styleable.CustomSeekBar_bsb_section_text_color, mTrackColor);
        isSeekStepSection = a.getBoolean(R.styleable.CustomSeekBar_bsb_seek_step_section, false);
        isSeekBySection = a.getBoolean(R.styleable.CustomSeekBar_bsb_seek_by_section, false);
        int pos = a.getInteger(R.styleable.CustomSeekBar_bsb_section_text_position, NONE);
        if (pos == 0) {
        ...
        mSectionTextInterval = a.getInteger(R.styleable.CustomSeekBar_bsb_section_text_interval, 1);
        isShowThumbText = a.getBoolean(R.styleable.CustomSeekBar_bsb_show_thumb_text, false);
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.CustomSeekBar_bsb_thumb_text_size, sp2px(14));
        mThumbTextColor = a.getColor(R.styleable.CustomSeekBar_bsb_thumb_text_color, mSecondTrackColor);
        mBubbleColor = a.getColor(R.styleable.CustomSeekBar_bsb_bubble_color, mSecondTrackColor);
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.CustomSeekBar_bsb_bubble_text_size, sp2px(14));
        mBubbleTextColor = a.getColor(R.styleable.CustomSeekBar_bsb_bubble_text_color, Color.WHITE);
        isShowSectionMark = a.getBoolean(R.styleable.CustomSeekBar_bsb_show_section_mark, false);
        isAutoAdjustSectionMark = a.getBoolean(R.styleable.CustomSeekBar_bsb_auto_adjust_section_mark, false);
        isShowProgressInFloat = a.getBoolean(R.styleable.CustomSeekBar_bsb_show_progress_in_float, false);
        int duration = a.getInteger(R.styleable.CustomSeekBar_bsb_anim_duration, -1);
        mAnimDuration = duration < 0 ? 200 : duration;
        isTouchToSeek = a.getBoolean(R.styleable.CustomSeekBar_bsb_touch_to_seek, false);
        isAlwaysShowBubble = a.getBoolean(R.styleable.CustomSeekBar_bsb_always_show_bubble, false);
        duration = a.getInteger(R.styleable.CustomSeekBar_bsb_always_show_bubble_delay, 0);
        mAlwaysShowBubbleDelay = duration < 0 ? 0 : duration;
        isHideBubble = a.getBoolean(R.styleable.CustomSeekBar_bsb_hide_bubble, false);
        isRtl = a.getBoolean(R.styleable.CustomSeekBar_bsb_rtl, false);
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowThumbText && !isThumbOnDragging) {
            ...
            if (isFloatType || (isShowProgressInFloat && mSectionTextPosition == BOTTOM_SIDES &&
                ...
                if (getProgress()==100){
                    canvas.drawText(String.valueOf(getProgress()+"%"), mThumbCenterX-12, y_, mPaint);
                }else {
    ...
    /**
     * When CustomSeekBar's parent view is scrollable, must listener to it's scrolling and call this
    ...
    void config(SeekBarConfigBuilder builder) {
        mMin = builder.min;
        mMax = builder.max;
    ...
    public SeekBarConfigBuilder getConfigBuilder() {
        if (mConfigBuilder == null) {
            mConfigBuilder = new SeekBarConfigBuilder(this);
        }
    ...
    public interface CustomSectionTextArray {
         ...
         * }</pre>
         *
         * @param sectionCount The section count of the {@code CustomSeekBar}.
